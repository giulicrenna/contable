...
labelseleccion = Label(miframe, text='S.A.N.T.I', font=30).place(x=225,y=50)
labelseleccion2 = Label(miframe, text='Algoritmo básico de selección de candidatos', font=30).place(x=100,y=100)
labelseleccion3 = Label(miframe, text='(por valorización numérica)', font=30).place(x=160,y=150)

class empezar():
    def funcion():
        print('seleccione la cantidad de candidatos')
    ttk.Button(raiz, text='Empezar', command=funcion).pack(side=BOTTOM) 
def main():
    mi_app = empezar()
    return 0
###################################################################################################################
...
print ('#             (SELECCIÓN POR VALORIZACIÓN NUMÉRICA)             #')  #sistema algoritmizado natural con transcripcion intuitiva
print ('#                                                               #')
print ('#                                                               #')
...
if opcion == '':
    ...
    print ('usted no apretó enter') 
####################################################################
####################################################################   
if opcion2 == 2:                     #de a dos candidatos                            #Hacer la interfaz gráfica a partir de transformar las opciones en clases
    ...
    if candidato1_2: #ALGORITMO DEL SEGUNDO CANDIDATO
        ...
        masas = input()
        if masas == 'si': 
            candi2 -= 20000000000000000
        if masas == 'no':   
            candi2 += 5
    list1 = [candidato1_1, candidato1_2]   
    candi1 = str(candidato1_1)
    candi2 = str(candidato1_2)
...
if opcion2 == 3: # DE A TRES CANDIDATOS
    ...
    if candidato2_2: #ALGORITMO DEL PRIMER CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi2 -= 400000000000000000000000
        if asesinado == 'no':   
            candi2 += 5
...
if opcion2 == 4:
    ...
    if candidato3_2: #ALGORITMO DEL PRIMER CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi2 -= 4000000000000000000000000000
        if asesinado == 'no':   
            candi2 += 5
        ...
        masas = input()
        if masas == 'si': 
            candi2 -= 2000000000000000000000000000000
        if masas == 'no':   
            candi2 += 5        
    ...
    if candidato3_3: #ALGORITMO DEL PRIMER CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi3 -= 4000000000000000000000000000
        if asesinado == 'no':   
            candi3 += 5
        ...
        masas = input()
        if masas == 'si': 
            candi3 -= 20000000000000000000000000
        if masas == 'no':   
            candi3 += 5       
...
if opcion2 == 5:
    ...
    if candidato4_1: #ALGORITMO DEL PRIMER CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi1 -= 40000000000000000000000000000
        if asesinado == 'no':   
            candi1 += 5
        ...
        masas = input()
        if masas == 'si': 
            candi1 -= 200000000000000000000000
        if masas == 'no':   
            candi1 += 5
    ...
    if candidato4_2: #ALGORITMO DEL PRIMER CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi2 -= 400000000000000000000000000000000
        if asesinado == 'no':   
            candi2 += 5
        ...
        masas = input()
        if masas == 'si': 
            candi2 -= 20000000000000000000000000000000000
        if masas == 'no':   
            candi2 += 5        
    ...
    if candidato4_3: #ALGORITMO DEL PRIMER CANDIDATO
        ...
        masas = input()
        if masas == 'si': 
            candi3 -= 200000000000000000000000000000000
        if masas == 'no':   
            candi3 += 5       
    ...
    if candidato4_4: #ALGORITMO DEL SEGUNDO CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi4 -= 400000000000000000000000000
        if asesinado == 'no':   
            candi4 += 5
        ...
        masas = input()
        if masas == 'si': 
            candi4 -= 20000000000000000000000000000000
        if masas == 'no':   
            candi4 += 5
    ...
    if candidato4_5: #ALGORITMO DEL SEGUNDO CANDIDATO
        ...
        asesinado = input()
        if asesinado == 'si':
            candi4 -= 400000000000000000000000
        if asesinado == 'no':   
            candi4 += 5
...
#################################################################################FIN ALGORITMO######################################
#################################################################################FIN ALGORITMO######################################
print('Aprieta Enter para cerrar el algoritmo')
cerrar = input()        
raiz.mainloop()